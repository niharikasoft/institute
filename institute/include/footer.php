<footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="#">Niharika Software</a>.</strong>
    All rights reserved.
...
<script src="../files/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
<!-- InputMask -->
<script src="../files/plugins/moment/moment.min.js"></script>
<script src="../files/plugins/inputmask/jquery.inputmask.min.js"></script>
<!-- ChartJS -->
...
<!-- Bootstrap Switch -->
<script src="../files/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- BS-Stepper -->
<script src="../files/plugins/bs-stepper/js/bs-stepper.min.js"></script>
<!-- dropzonejs -->
<script src="../files/plugins/dropzone/min/dropzone.min.js"></script>
<!-- overlayScrollbars -->
