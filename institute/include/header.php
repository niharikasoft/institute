...
<head>
  ...
  <link rel="stylesheet" href="../files/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
   ...
   <link rel="stylesheet" href="../files/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  <!-- Select2 -->
  ...
  <link rel="stylesheet" href="../files/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="../files/plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="../files/plugins/dropzone/min/dropzone.min.css">
   <!-- JQVMap -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="../files/plugins/summernote/summernote-bs4.min.css">
</head>
...
<div class="wrapper">
  ...
  <!-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../files/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div> -->
